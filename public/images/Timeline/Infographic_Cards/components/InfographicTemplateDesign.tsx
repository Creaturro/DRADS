import imgImage from "figma:asset/5d9bfa4e8c9c2f6a1e4b7d3c8a5f9e2b6c1d4e7f.png";
    ...
    >
      ...
      <div className="relative shrink-0 text-[14px] w-full h-auto md:h-[134px]">
        <p className="block leading-[22px]">
          Our design process runs in parallel with development, allowing for
          rapid iteration and real-time feedback. Designers can work on future
          features while developers implement current ones.
        </p>
      </div>
    </div>
  );
...
function DesignImg() {
  return (
    <div
      className="relative h-48 w-64 overflow-visible md:h-[226px] md:w-[232px] md:overflow-clip"
      data-name="Design img"
    >
      <div className="absolute flex h-[226px] items-center justify-center w-[232px] left-0 top-0">
        <div
          className="bg-center bg-cover bg-no-repeat h-[226px] w-[232px]"
          data-name="image"
