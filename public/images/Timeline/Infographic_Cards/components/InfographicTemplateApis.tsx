import imgImage from "figma:asset/1a7c2e5f9b8d4c6a3e7f1d8c5b9a2e6f4c7d1e8b.png";
    ...
    >
      ...
      <div className="relative shrink-0 text-[14px] w-full h-auto md:h-[134px]">
        <p className="block leading-[22px]">
          Rather than building everything from scratch, we integrate existing
          services and systems through APIs. This approach accelerates
          development while maintaining scalability and reliability.
        </p>
      </div>
    </div>
  );
...
function ApisImg() {
  return (
    <div
      className="relative h-48 w-64 overflow-visible md:h-[255px] md:w-[214px] md:overflow-clip"
      data-name="Apis img"
    >
      <div className="absolute flex h-[255px] items-center justify-center w-[214px] left-0 top-0">
        <div
          className="bg-center bg-cover bg-no-repeat h-[255px] w-[214px]"
          data-name="image"
...
export default function InfographicTemplateApis() {
  return (
    <div
