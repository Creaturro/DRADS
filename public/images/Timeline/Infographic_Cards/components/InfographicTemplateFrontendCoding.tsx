...
function CardBg() {
  return (
    <div
      className="absolute left-0 top-0 h-[460px] w-full md:h-[325px] md:w-[595px]"
      data-name="card bg"
    />
  );
}
...
function FrontendImg() {
  return (
    <div
      className="relative h-48 w-64 overflow-visible md:h-[316px] md:w-[281px] md:overflow-clip"
      data-name="Frontend img"
    >
      <div className="absolute flex h-[316px] items-center justify-center w-[281px] left-0 top-0">
        <div
          className="bg-center bg-cover bg-no-repeat h-[316px] w-[281px]"
          data-name="image"
...
export default function InfographicTemplateFrontendCoding() {
  return (
    <div
      className="bg-[#1d282f] relative size-full min-h-[460px] md:min-h-[325px]"
      data-name="infographic_template_frontend_coding"
    >
      <CardBg />
      <TextBg />
      <Content />
