...
function CardBg() {
  return (
    <div
      className="absolute bg-[#25202d] h-[333px] left-0 top-[-22px] w-[595px]"
      data-name="card bg"
    />
  );
}
...
function TextBg() {
  return (
    <div
      className="absolute bg-[#302a38] h-[231px] left-[13px] rounded-xl top-1/2 -translate-y-1/2 w-[350px]"
      data-name="text bg"
    />
  );
}
...
function Text() {
  return (
    <div
      className="box-border content-stretch flex flex-col font-['Open_Sans:Regular',_sans-serif] gap-3.5 items-start justify-start leading-[0] not-italic p-[16px] relative rounded-lg shrink-0 text-[#ffffff] text-left w-[291px]"
      data-name="text"
    >
...
function Content() {
  return (
    ...
    >
      <Text />
      <div
        className="bg-center bg-cover bg-no-repeat h-[211px] shrink-0 w-[248px]"
        data-name="image"
