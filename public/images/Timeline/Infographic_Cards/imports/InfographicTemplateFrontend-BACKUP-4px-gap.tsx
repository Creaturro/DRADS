...
function CardBg() {
  return (
    <div
      className="absolute left-0 top-0 h-[400px] w-full md:h-[333px] md:w-[595px]"
      data-name="card bg"
    />
  );
}
...
function TextBg() {
  return (
    <div
      className="absolute bg-[#302a38] rounded-xl h-44 left-[13px] bottom-[13px] right-[13px] z-0 md:h-64 md:left-[13px] md:top-[41px] md:w-[350px] md:right-auto md:bottom-auto md:z-10"
      data-name="text bg"
    />
  );
}
...
function Content() {
  return (
    <>
      ...
      <div className="hidden md:flex md:flex-row md:items-center md:gap-1 md:absolute md:left-[26px] md:top-[38px] md:z-20" data-name="content-desktop">
...
export default function InfographicTemplateFrontend() {
  return (
    <div
      className="bg-[#25202d] relative size-full min-h-[400px] md:min-h-[333px]"
